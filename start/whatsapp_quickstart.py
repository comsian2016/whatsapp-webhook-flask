...
# Check if ACCESS_TOKEN is loaded properly
if not ACCESS_TOKEN:
    raise ValueError("ACCESS_TOKEN is not set. Please check your .env file.")
...
loop.run_until_complete(send_message_async(data))
loop.close()
